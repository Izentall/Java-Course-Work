...
import Service_3.Crane;
import Service_3.Ship;
...
public class Report
{
    ...
    public Report(Statistic statistic, int numberOfCranesPowdery, int numberOfCranesLiquid, int numberOfCranesContainer)
    {
